...
export default function Navbar(){
  ...
  return (
    <div className="relative w-screen mx-auto px-6">
      ...
      bg-[rgb(var(--muted)/0.25)] background-blur-md ">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 md:flex gap-6 hidden">
          <Link href="#skills" className="transition-transform duration-300 hover:scale-125 ease-out">About</Link>
        ...
        <div className="flex items-center gap-[24px] justify-between px-3 md:gap-4 sm:gap-1">
        ...
        {open && (
          ...
          bg-[rgb(var(--bg))] shadow-lg z-50">
            <div className="px-6 py-4 flex flex-col gap-4">
              <Link href='#skills' onClick={()=> setOpen(false)}>About</Link>
